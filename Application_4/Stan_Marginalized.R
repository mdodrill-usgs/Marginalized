...
allCH <- MR_data[,1:23]                       # Need to run this including the last col --> 24 and compare
...
all.stan.m.2 = all.out
rm(list=setdiff(ls(), c("all.stan.m.2")))

save.image("U:/Desktop/Fish_Git/Marginalized/Application_6/working_runs/Stan_runs_2.RData")
#-----------------------------------------------------------------------------#
# end
